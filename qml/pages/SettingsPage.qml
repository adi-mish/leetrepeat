...
Page {
    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            Label { textFormat: Text.PlainText; text: "Review intervals (days)"; font.bold: true }
            TextField { id: intervals; Layout.fillWidth: true; placeholderText: "1,2,4,7,14,30,60,120,240" }
            Label { textFormat: Text.PlainText; text: "Use 1–32 strictly increasing positive integers, up to 36500 days. Initial learning and FAIL always schedule tomorrow. Changes affect future scheduling, leaving existing due dates intact."; wrapMode: Text.Wrap; Layout.fillWidth: true; opacity: 0.7 }
            ...
            Label { textFormat: Text.PlainText; text: "Your data"; font.pixelSize: 22; font.bold: true; Layout.topMargin: 20 }
            Label { textFormat: Text.PlainText; text: "Database location"; font.bold: true }
            ...
            Label { textFormat: Text.PlainText; text: "Backups include problems, notes, tags, settings, and full attempt history. Choose a new filename for each backup. To restore, close LeetRepeat and replace its database with a backup (see README). CSV exports are available in Problems."; wrapMode: Text.Wrap; Layout.fillWidth: true; opacity: 0.7 }
        }
    }
}
